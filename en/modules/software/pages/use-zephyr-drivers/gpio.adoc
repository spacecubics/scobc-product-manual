...
NOTE: To use the Zephyr console, bit3 (RX) and bit4 (TX) of DIP Switch (_SW1_) must be turned ON.
...
NOTE: To flash with `west flash`, bit5 and bit6 of DIP Switch (_SW1_) must be turned ON.
